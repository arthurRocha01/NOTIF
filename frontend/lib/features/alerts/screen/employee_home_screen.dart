...
class _EmployeeHomeScreenState extends State<EmployeeHomeScreen> {
  ...
  static const _mockAlerts = [
    _MockAlert(
      initials: 'TI',
      avatarColor: Color(0xFF3B5BDB),
      sector: 'SETOR DE TI',
      timeAgo: 'há 40 min',
      title: 'Atualização do sistema de acesso',
      description: 'O sistema de catracas será atualizado amanhã das 08h às 10h. Acesso manual liberado durante a janela.',
      isRead: false,
      status: 'Pendente',
    ),
    _MockAlert(
      ...
      description: 'Você deve concluir o módulo NR-10 até sexta-feira. Acesse pelo portal de treinamentos.',
      isRead: false,
      status: 'Pendente',
    ),
    _MockAlert(
      ...
      description: 'O novo protocolo de segurança para equipamentos elétricos entra em vigor a partir de hoje.',
      isRead: true,
      status: 'Confirmado',
    ),
  ];
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '$_unreadCount alertas não lidos',
  ...
  Widget _buildAlertItem(_MockAlert alert) {
    final actionColor = alert.isRead ? AppColors.textTertiary : AppColors.accent;
    final actionLabel = alert.isRead ? 'Confirmado' : 'Confirmar leitura';
    final actionIcon = alert.isRead ? Icons.verified_rounded : Icons.check_rounded;
