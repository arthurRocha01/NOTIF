...
import { AssignmentInteractionController } from './presentation/assigment-interation.controller';
...
@Module({
  ...
  controllers: [AssignmentInteractionController, AssignmentController],
